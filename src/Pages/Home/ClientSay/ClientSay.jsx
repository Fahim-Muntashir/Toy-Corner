...
const ClientSay = () => {
    return (
        <section className="mx-auto my-20 xl:px-36 sm:py-6 lg:px-8 container">
        <div className="mx-auto max-w-screen-2xl sm:px-6 lg:px-8 lg:py-16">
          <div className="md:flex md:items-end md:justify-between">
            ...
            <a
              href="#"
              className="mt-6 inline-flex shrink-0 items-center gap-2 rounded-full border border-yellow-400 px-5 py-3 text-white-600 transition hover:bg-yellow-400 hover:text-white md:mt-0"
            >
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
            <blockquote
              className="flex h-full flex-col justify-between bg-white-200 p-6 shadow-sm sm:p-8"
            >
              <div>
