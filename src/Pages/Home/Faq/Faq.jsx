...
const Faq = () => {
    return (
        <section className="container sm:px-6 lg:px-8 mx-auto py-9 md:py-12 px-4 md:px-6 bg-gray-000 text-gray-100">
        <div className="container max-w-7xl flex flex-col justify-center p-4 mx-auto md:p-8">
