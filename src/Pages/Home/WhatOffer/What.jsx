...
const What = () => {
    return (
            <div className="backdrop-blur-sm bg-black/30 dark:text-gray-50 md:px-40 sm:px-10 py-16 px-16 mx-auto sm:max-w-xl lg:max-w-full md:max-w-full text-gray-100">
